...
$(document).ready(function(){function e(e){$("#carrusel-estar").find(".owl-item:nth-child(2)").hasClass("active")?$("#carrusel-estar").addClass("carrusel-estar-2"):$("#carrusel-estar").removeClass("carrusel-estar-2")}function a(){$(window).width()>996?$(".home--final--copy").append($(".home--final--col h4")):$(".home--final--col").append($(".home--final--col h4"))}$(".header--navegacion .btn").on("click",function(){$(this).toggleClass("nav-on")}),$("#navbarNav li").on("click",function(){var e=$(this).attr("class").replace("li-","home--");nameSection=$("."+e).offset().top-100,$("html, body").animate({scrollTop:nameSection},800),$(".header--navegacion .btn").removeClass("nav-on"),$(".navbar-collapse").removeClass("show"),$("#navbarNav li").removeClass("activo"),$(this).addClass("activo")}),$("#carrusel-estar").owlCarousel({autoplay:!1,nav:!0,loop:!1,responsive:{0:{items:1,dots:!0,onDragged:e},996:{items:2,dots:!1,mouseDrag:!1}}}),$("#carrusel-estigmas").owlCarousel({autoplay:!1,dots:!0,nav:!0,items:1,loop:!1,responsive:{996:{items:3,slideBy:3}}}),$("#carrusel-recorrido").owlCarousel({autoplay:!1,dots:!0,nav:!0,items:1,loop:!1,responsive:{996:{items:3,slideBy:3}}}),$(".home--busqueda--form label").on("click",function(){$(this).find("input").attr("checked")?$(this).find("input").removeAttr("checked"):$(this).find("input").attr("checked","checked")}),$(".home--busqueda--form select").on("change",function(){$(".home--busqueda .btn-on").parent().attr({href:$(this).val(),target:"_blank"})}),$(".home--busqueda .btn-on").on("click",function(){if(null!=$(".home--busqueda--form select").val())return 2==$(".checkbox[checked]").length||(alert("Acepta nuestros Términos y Aviso de Privacidad"),!1);alert("Elige un estado ")}),a(),$(window).on("resize",function(){a()});var o=$("section");$(document).scroll(function(){o.each(function(){var e=$(this).offset().top-500,a=$(window).scrollTop(),o=$(this).attr("class").replace("home--","li-");a>e&&($("#navbarNav li").removeClass("activo"),$("."+o).addClass("activo"))})})});
