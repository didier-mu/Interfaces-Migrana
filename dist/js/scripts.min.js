...
$(document).ready(function(){function e(e){$("#carrusel-estar").find(".owl-item:nth-child(1)").hasClass("active")?$("#carrusel-estar").addClass("carrusel-estar-2"):$("#carrusel-estar").removeClass("carrusel-estar-2")}function o(){$(window).width()>996?$(".home--final--copy").append($(".home--final--col h4")):$(".home--final--col").append($(".home--final--col h4"))}function a(){var e=document.createElement("input"),o=window.location.href;document.body.appendChild(e),e.value=o,e.select(),document.execCommand("copy"),document.body.removeChild(e)}$(".header--navegacion .btn").on("click",function(){$(this).toggleClass("nav-on")}),$("#navbarNav li").not(".li-video").on("click",function(){var e=$(this).attr("class").replace("li-","home--");$("."+e).offset().top;return $("html, body").animate({scrollTop:$("."+e).offset().top-150},1500),$(".header--navegacion .btn").removeClass("nav-on"),$(".navbar-collapse").removeClass("show"),$("#navbarNav li").removeClass("activo"),$(this).addClass("activo"),!1}),$(".btn-doctors").on("click",function(){$(".home--busqueda").offset().top;return $("html, body").animate({scrollTop:$(".home--busqueda").offset().top-200},1500),$(this).addClass("on-doc"),setTimeout(function(){$(".btn-doctors").removeClass("on-doc")},2e3),!1}),$(".li-video").hasClass("d-none")&&$(".header--logo").addClass("l-m"),$("#carrusel-estar").owlCarousel({autoplay:!1,nav:!0,loop:!1,responsive:{0:{items:1,dots:!0,onChanged:e},996:{items:2,dots:!1,mouseDrag:!1}}}),$("#carrusel-estigmas").owlCarousel({autoplay:!1,dots:!0,nav:!0,items:1,loop:!1,responsive:{996:{items:3,slideBy:3}}}),$("#carrusel-estigmas .owl-prev").attr("id","prev-estigma"),$("#carrusel-estigmas .owl-next").attr("id","next-estigma"),$("#carrusel-recorrido").owlCarousel({autoplay:!1,dots:!0,nav:!0,items:1,loop:!1,responsive:{996:{items:3,slideBy:3}}}),$("#carrusel-recorrido .owl-prev").attr("id","prev-recorrido"),$("#carrusel-recorrido .owl-next").attr("id","next-recorrido"),$(".home--busqueda--form label").on("click",function(){$(this).find("input").attr("checked")?$(this).find("input").removeAttr("checked"):$(this).find("input").attr("checked","checked")}),$(".home--busqueda--form select").on("change",function(){$(".home--busqueda .btn-on").parent().attr({href:$(this).val(),target:"_blank"}),$(".alert").fadeOut()}),$(".home--busqueda .btn-on").on("click",function(){if(null!=$(".home--busqueda--form select").val())return 2==$(".checkbox[checked]").length?($(".alert").fadeOut(),window.dataLayer=window.dataLayer||[],window.dataLayer.push({event:"buscarEspecialista_Grt"}),!0):($(".alert").fadeIn(),$(".alert").text("Acepta nuestros Términos y Aviso de Privacidad"),!1);$(".alert").fadeIn()}),o(),$(window).on("resize",function(){o()});var t=$("section");$(document).scroll(function(){t.each(function(){var e=$(this).offset().top-500,o=$(window).scrollTop(),a=$(this).attr("class").replace("home--","li-");o>e&&($("#navbarNav li").removeClass("activo"),$("."+a).addClass("activo"))})}),$(".home--dia--redes--share").on("click",function(){a(),$(this).siblings("span").remove(),$(this).append("<span class='error-input'>¡Listo para compartir!"),setTimeout(function(){$(".error-input").remove()},3e3)}),function(){var e=document.querySelector("#selectEdo"),o=function(e){var o=e.target.options[e.target.selectedIndex];window.dataLayer.push({event:"seleccionarEstado",selectedElement:o})};e.addEventListener("change",o,!0)}()});
